...
export const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        Currently based in Bangalore, India — Open to relocate
      </motion.p>
      <motion.h1
      ...
      >
        Hi I'm <span className="bg-gradient-to-r from-rose-700 to-pink-600 bg-clip-text text-transparent">Kaushal Chaudhary</span>- Frontend Engineer.
      </motion.h1>
      <motion.p
        initial={prefersReducedMotion ? { opacity: 1 } : { opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: prefersReducedMotion ? 0 : 0 }}
      ...
      >
        ...
        React.js, Next.js, Tailwind CSS, and TypeScript. With 1+ years of
        experience and strong front-end skills, I am passionate about creating 
        smooth user interfaces, maintaining excellent UI/UX, and writing clean, 
        maintainable code. I craft modern user experiences while also delivering
        scalable backend integrations when needed.
      </motion.p>
      <motion.div
        initial={prefersReducedMotion ? { opacity: 1 } : { opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: prefersReducedMotion ? 0 : 0 }}
      ...
      >
        <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:gap-2">
          ...
          >
            <a
              href="/cv/Kaushal Chaudhary CV.pdf"
              target="_blank"
        ...
        <div className="flex flex-row flex-wrap justify-center gap-2 sm:justify-start">
          <Button variant="outline" size="icon" asChild>
            <Link
              href="https://www.linkedin.com/in/kaushal-chaudhary-a633721a6/"
              aria-label="Linkedin"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <Button variant="outline" size="icon" asChild>
            <Link
              href="https://github.com/kaushal19097"
              aria-label="Github"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <Button variant="outline" size="icon" asChild>
            <Link
              href="https://www.instagram.com/imkaushalchaudhary/"
